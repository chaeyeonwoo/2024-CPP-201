...
void main(void) {
	...
	cout << "지혜 gam의 주소" << jihye->get_address_num() << endl;
	cout << "주영 gam의 주소" << juyoung->get_address_num() << endl;
	cout << "정민 gam의 주소" << jungmin->get_address_num() << endl;
	cout << "지우 gam의 주소" << jiwoo->get_address_num() << endl << endl;
